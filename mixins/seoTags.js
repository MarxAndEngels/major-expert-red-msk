...
export default {
    ...
    head() {
        let currentMeta = [
            ...
            //     content: this.domain == 'https://'+mainDomain.domain ? '1893c9f126055e46' : ''
            // },
            {
                hid: 'desctiption',
                name: 'description',
            ...
            },
            {
                hid: 'og:image',
                property: 'og:image',
                content: this.domain + '/img/sliders/main/slider-index-3.png'
            }
        ]
        if (this.domain !== 'https://'+mainDomain.domain) {
            currentMeta.push({
                name: 'robots',
